...
def save_diff_for_analysis(
    ...
    Args:
        ...
        repo_path:   git 專案根目錄
        diff_dir:    diff 輸出目錄（預設：cr/diff）
        result_dir:  JSON 分析結果存放目錄（預設：cr/analysis）
...
if __name__ == "__main__":
    ...
    parser.add_argument("--diff-dir", default="cr/diff", help="diff 輸出目錄（預設：cr/diff）")
    parser.add_argument("--result-dir", default="cr/analysis", help="JSON 結果存放目錄（預設：cr/analysis）")
